...
namespace Mehler\Easyuser\Tests\Unit\Domain\Model;
...
/**
 * Test case for class \Mehler\Easyuser\Domain\Model\Person.
 *
...
class PersonTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Mehler\Easyuser\Domain\Model\Person
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Mehler\Easyuser\Domain\Model\Person();
	}
