...
/**
 * Test case for class \Mehler\Simpleproject\Domain\Model\Issue.
 *
 ...
 */
class IssueTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Mehler\Simpleproject\Domain\Model\Issue
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Mehler\Simpleproject\Domain\Model\Issue();
	}
